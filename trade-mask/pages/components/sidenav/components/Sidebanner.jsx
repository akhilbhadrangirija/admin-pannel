...
function Sidebanner() {
  return (
    <div className='container  w-full p-5 px-5 bg-white rounded-lg drop-shadow-xl'>
        ...
        <div  type="button" class="  max-h-10 w-full flex flex-row justify-between items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 mr-2 mb-2 dark:bg-blue-700 dark:hover:bg-blue-800 dark:hover:text-white focus:outline-none dark:focus:ring-blue-800">
